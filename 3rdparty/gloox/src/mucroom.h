...
namespace gloox
{
   ...
   * @code
   * void MyOtherClass::createRoom( const std::string& room, const std::string& service,
                            ...
                            public IqHandler, private MessageHandler, private DiscoNodeHandler
  {
    public:
       ...
       */
      void send(const std::string &message, const std::string &id);
...
// reimplemented from DiscoNodeHandler
      virtual void handleDiscoItemsResult(const JID &from, const Disco::ItemList &items);
