...
//#warning FIXME return something useful (only 'show' values?) or kill this func
      ...
      virtual const Devices *devices() const;
      virtual const AudioMuted *audioMuted() const;
      virtual const VideoMuted *videoMuted() const;
      virtual const VideoType *videoType() const;
      virtual const RaisedHand *raisedHand() const;
    ...
    private:
      ...
      Devices* m_devices;
      AudioMuted *m_audioMuted;
      VideoMuted *m_videoMuted;
      VideoType *m_videoType;
      RaisedHand *m_raisedHand;
  };
}
