...
#define PUBSUB_SERVICE gloox::JID("pubsub.webrtc.chuanshaninfo.com")
//const std::string PUBSUB_NODE = "SmartBoard";

IMSmartBoard::IMSmartBoard() : _painterDispatcher(nullptr) {

}

IMSmartBoard::~IMSmartBoard() {  }

//void IMSmartBoard::setJingle(IMJingle *jingle) {
//  if (!jingle) {
...
//  }
  //            _pubsubManager =
  //            std::make_shared<gloox::PubSub::Manager>(session->client());
//}

//void IMSmartBoard::jingleInitiate() { DEBUG_LOG(("...")); }
//
//void IMSmartBoard::jingleAccept() {
//  DEBUG_LOG(("..."));
//
//  // _pubsubManager->subscribe(PUBSUB_SERVICE, PUBSUB_NODE, this, gloox::JID(),
//  // gloox::PubSub::SubscriptionNodes, 0);
//}
//
//void IMSmartBoard::jingleTerminate() { DEBUG_LOG(("...")); }
//
...
//void IMSmartBoard::handleItems(const std::string &id, const gloox::JID &service,
//                               const std::string &node,
...
//void IMSmartBoard::handleItemPublication(
//    const std::string &id, const gloox::JID &service, const std::string &node,
...
//void IMSmartBoard::handleSubscriptionResult(
//    const std::string &id, const gloox::JID &service, const std::string &node,
//    const std::string &sid, const gloox::JID &jid,
...
//void IMSmartBoard::handleSubscriptionOptions(
//    const std::string &id, const gloox::JID &service, const gloox::JID &jid,
...
//                                                   const gloox::Error *error) {}
//
//void IMSmartBoard::handleSubscribers(
//    const std::string &id, const gloox::JID &service, const std::string &node,
//    const gloox::PubSub::SubscriptionList &list, const gloox::Error *error) {}
//
//void IMSmartBoard::handleSubscribersResult(
//    const std::string &id, const gloox::JID &service, const std::string &node,
//    const gloox::PubSub::SubscriberList *list, const gloox::Error *error) {}
//
...
//                                    const gloox::Error *error) {}
//
//void IMSmartBoard::handleAffiliatesResult(
//    const std::string &id, const gloox::JID &service, const std::string &node,
...
//void IMSmartBoard::handleNodeDeletion(const std::string &id,
//                                      const gloox::JID &service,
//                                      const std::string &node,
//                                      const gloox::Error *error) {}
//
//void IMSmartBoard::handleNodePurge(const std::string &id,
//                                   const gloox::JID &service,
//                                   const std::string &node,
//                                   const gloox::Error *error) {}

//void IMSmartBoard::handleSubscriptions(
//    const std::string &id, const gloox::JID &service,
//    const gloox::PubSub::SubscriptionMap &subMap, const gloox::Error *error) {
...
//void IMSmartBoard::handleAffiliations(
//    const std::string &id, const gloox::JID &service,
//    const gloox::PubSub::AffiliationMap &affMap, const gloox::Error *error) {
//  DEBUG_LOG(("begin args id:%1 service:%2 subMap:%3")
//                .arg(qstring(id))
//                .arg(qstring(service.full()))
//                .arg(affMap.size()));
...
//
//  _pubsubManager->publishItem(PUBSUB_SERVICE, PUBSUB_NODE, items, nullptr,
//                              this);
//}
...
//}
//
//void IMSmartBoard::sendController(
//    std::shared_ptr<SmartBoard::Controller> controller) {
...
//    return;
  ...
  // const SmartBoard::ControllerVoice *cVoice =
  // controller->findPlugin<SmartBoard::ControllerVoice>(SmartBoard::ControllerType::Voice);
  // if (cVoice)
  // {
