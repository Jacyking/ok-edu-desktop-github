...
class IM : public ok::lib::Task,
  ...
  Q_OBJECT
public:
  explicit IM(const QString &user, const QString &pwd,
  ...
  MUCRoom *findRoom(const QString &groupId) const;
...
private:
  ...
  QMap<QString, MUCRoom *> m_roomMap;
...
signals:
  ...
  void groupRoomName(const QString groupId, const QString name);
