...
namespace Util
{
	...
	QPointF calculateNewItemPos( int sceneWidth, int sceneHeight, int mouseX, int mouseY, int targetWidth, int targetHeight, double *lastItemPosX = nullptr, double *lastItemPosY = nullptr );
	QPointF calculateNewTextPos( int sceneWidth, int sceneHeight, int mouseX, int mouseY, int textSize, double *lastTextPosX = nullptr, double *lastTextPosY = nullptr );
	...
	inline QString checkAndChangeSameFileName( const QString &path, const QString *baseName = nullptr, int index = 1 )
	{
