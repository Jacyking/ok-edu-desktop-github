...
public:
	...
	void setListenTcpPort( std::uint16_t port ) { data_.listenTcpPort = port; }
	...
	void setScreenStreamListenPort( std::uint16_t port ) { screenStreamListenPort_ = port; }
	...
	std::uint16_t listenTcpPort( void ) { return data_.listenTcpPort; }
	...
	std::uint16_t screenStreamListenPort( void ) { return screenStreamListenPort_; }
