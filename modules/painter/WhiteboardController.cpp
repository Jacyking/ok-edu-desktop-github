...
namespace painter
{
    ...
    static WB_CTRL_BTN btns[] = {
        {WB_CTRL::MOVE, 32, 38, "://res/icon/painter/btn_ctrl_plus.png", "://res/icon/painter/btn_ctrl_plus_active.png", true, true},
        {WB_CTRL::MUTE, 64, 20, "://res/icon/painter/btn_ctrl_mute.png", "://res/icon/painter/btn_ctrl_mute_active.png", false, true},
        {WB_CTRL::GIFT, 32, 1, "://res/icon/painter/btn_ctrl_gift.png", "://res/icon/painter/btn_ctrl_gift_active.png", false, false},
        {WB_CTRL::RE, 64, 56, "://res/icon/painter/btn_ctrl_refresh.png", "://res/icon/painter/btn_ctrl_refresh_active.png", false, false},
        {WB_CTRL::WB, 0, 56, "://res/icon/painter/btn_ctrl_wb.png", "://res/icon/painter/btn_ctrl_wb_active.png", false, true},
        {WB_CTRL::OK, 0, 20, "://res/icon/painter/btn_ctrl_ok.png", "://res/icon/painter/btn_ctrl_ok_active.png", false, true},
        {WB_CTRL::ALL, 32, 75, "://res/icon/painter/btn_ctrl_all.png", "://res/icon/painter/btn_ctrl_all_active.png", false, true},
    };

    WhiteboardControllerButton::WhiteboardControllerButton(QWidget *parent)
        : QLabel(parent)
    {
        setFixedSize(QSize(45, 35));
        setAlignment(Qt::AlignCenter);
        // Utils::SetPalette(this, QPalette::Background, QBrush(QPixmap("://res/icon/painter/btn_ctrl_bg.png")));
    ...
    WhiteboardController::WhiteboardController(QWidget *parent) : QWidget(parent)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            connect(btn, &WhiteboardControllerButton::clicked, this, [=]
                    {
                        WhiteboardControllerButton *sender = qobject_cast<WhiteboardControllerButton *>(QObject::sender());
                        ...
                        case WB_CTRL::RE:
                        {
                            emit checked(context::WB::WB_CTRL::RE, sender->isChecked());
                            break;
                        }

                        case WB_CTRL::OK:
                        {
                            emit checked(context::WB::WB_CTRL::OK, sender->isChecked());
                            break;
                        }

                        case WB_CTRL::GIFT:
                        {
                            emit checked(context::WB::WB_CTRL::GIFT, sender->isChecked());
                            break;
                        }

                        case WB_CTRL::MUTE:
                        {
                            emit checked(context::WB::WB_CTRL::MUTE, sender->isChecked());
                            break;
                        }

                        case WB_CTRL::WB:
                        {
                            emit checked(context::WB::WB_CTRL::WB, sender->isChecked());
                            break;
                        }
                        case WB_CTRL::ALL:
                            emit checked(context::WB::WB_CTRL::ALL, sender->isChecked());
                            break;
                        }
                    });
        }
