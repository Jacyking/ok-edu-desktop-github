...
namespace PaintPacketBuilder
{
	...
	public:
		...
		{		
			...
			try
			{
                ...
                return CommonPacketBuilder::makePacket( CODE_PAINT_SET_BG_GRID_LINE, data, nullptr, target );
			}catch(...)
			{
			}
	...
	{
	public:
        static std::string make( std::shared_ptr<CBackgroundImageItem> item, const std::string *target = nullptr )
		{		
