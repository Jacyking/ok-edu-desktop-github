...
// #include "UI/widget/im/IMViewport.h"
...
OPainterViewport::OPainterViewport(QWidget *parent)
    : QFrame(parent), ui(new Ui::OPainterViewport) {
    ui->setupUi(this);
...
OPainterViewport::~OPainterViewport() { delete ui; }
