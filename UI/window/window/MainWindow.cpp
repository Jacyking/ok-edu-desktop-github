...
#include "UI/window/page/PageFactory.h"
#include "UI/window/page/SettingsPage.h"
...
QFrame *MainWindow::initPage(PageMenu menu) {
  ...
  case PageMenu::classing:
    w = PageFactory::Create<page::PageClassing>(this);
    break;
#endif
  case PageMenu::chat:
    // ignore
    ...
    //  case PageMenu::record:
    //    //               w = new page::Record(this);
    //    break;
    //
    //  case PageMenu::calendar:
    //    //               w = new page::Calendar(this);
    //    break;
    //
    //  case PageMenu::email:
    //    //               w = new page::EMail(this);
    //    break;
    //
    //  case PageMenu::personal:
    //    //               w = new page::Personal(this);
    //    break;
    //
  case PageMenu::setting:
    w = PageFactory::Create<page::SettingsPage>(this);
    break;
  }
